...
class Graph:
    def __init__(self, graph_name='temp', api_key="dcb31709b452b1cf9dc26972add0fda6"):
        ...
        self.html = f'<h1>Definite Integral Solver and Visualizer</h1>\n' \
                    f'<body style= "width: 1200px; height: 700px">\n' \
                    ...
                    '\tvar calculator = Desmos.GraphingCalculator(elt, {keypad:false, settingsMenu:false, sliders:false, authorFeatures:true});\n'
